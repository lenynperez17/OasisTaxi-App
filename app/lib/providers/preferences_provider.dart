...
class PreferencesProvider extends ChangeNotifier {
  ...
  Future<void> init() async {
    try {
      ...
      _isInitialized = true;
      _isLoading = false;
      AppLogger.debug('✅ PreferencesProvider inicializado exitosamente');
    } catch (e) {
      _error = 'Error inicializando preferencias: $e';
      _isLoading = false;
      _isInitialized = false;
      AppLogger.error('Error en PreferencesProvider.init: $e');
    }
    notifyListeners();
  }
  ...
  Future<void> loadPreferences() async {
    try {
      ...
      AppLogger.debug('📱 Preferencias cargadas desde SharedPreferences');
    } catch (e) {
      AppLogger.error('Error cargando preferencias: $e');
    }
  ...
  Future<void> saveToFirebase(String userId) async {
    try {
      ...
      AppLogger.error('al guardar preferencias en Firebase', e);
    }
  }
  ...
  Future<void> loadFromFirebase(String userId) async {
    try {
      ...
      AppLogger.error('al cargar preferencias desde Firebase', e);
    }
  }
  ...
  Future<void> _saveAllToPrefs() async {
    try {
      ...
      AppLogger.debug('💾 Preferencias guardadas en SharedPreferences');
    } catch (e) {
      AppLogger.error('Error guardando preferencias: $e');
    }
  }
  ...
  Future<void> resetToDefaults() async {
    try {
      ...
      await _saveAllToPrefs();
      AppLogger.debug('🔄 Preferencias restablecidas a valores por defecto');
    } catch (e) {
      AppLogger.error('Error restableciendo preferencias: $e');
    }
    notifyListeners();
  }
  ...
  Future<void> clearAll() async {
    try {
      ...
      AppLogger.debug('🗑️ Todas las preferencias limpiadas');
    } catch (e) {
      AppLogger.error('Error limpiando preferencias: $e');
    }
  }
  ...
  Future<void> clearCache() async {
    try {
      ...
      _cacheSize = '0 MB';
      await _prefs.setString('cache_size', _cacheSize);
      AppLogger.debug('🧹 Caché limpiado');
      notifyListeners();
    } catch (e) {
      AppLogger.error('Error limpiando caché: $e');
    }
  }
