...
class OAuthConfig {
  ...
  // Google Web Client ID eliminado - solo móvil
  ...
  static String get facebookAppSecret =>
      dotenv.env['FACEBOOK_APP_SECRET'] ?? '';
  ...
  static bool get isGoogleConfigured =>
      ...
      !googleAndroidClientId.contains('YOUR_GOOGLE');

  static bool get isFacebookConfigured =>
      facebookAppId.isNotEmpty && !facebookAppId.contains('YOUR_FACEBOOK');

  static bool get isAppleConfigured => appleServiceId.isNotEmpty;

  // Apple Sign In
  static const String appleServiceId = 'com.oasistaxiapp.signin';
  static const String appleRedirectUri =
      'https://oasis-taxi-app.firebaseapp.com/__/auth/handler';
...
class AuthErrorMessages {
  static const Map<String, String> messages = {
    ...
    'weak-password':
        'La contraseña es muy débil. Usa al menos 8 caracteres con mayúsculas, minúsculas, números y símbolos.',
    'network-request-failed':
        'Error de conexión. Verifica tu internet e intenta de nuevo.',
    'too-many-requests':
        'Demasiados intentos. Por favor espera unos minutos antes de intentar de nuevo.',
    'user-disabled':
        'Esta cuenta ha sido deshabilitada. Contacta a soporte para más información.',
    'operation-not-allowed':
        'Esta operación no está permitida. Contacta a soporte.',
    ...
    'quota-exceeded':
        'Se ha excedido la cuota de verificaciones. Intenta más tarde.',
    'app-not-authorized':
        'La aplicación no está autorizada para usar Firebase Authentication.',

    // Errores personalizados
    'account-locked':
        'Tu cuenta ha sido bloqueada temporalmente por seguridad. Intenta de nuevo en 30 minutos.',
    'email-not-verified':
        'Por favor verifica tu email antes de iniciar sesión. Revisa tu bandeja de entrada.',
    'phone-not-verified':
        'Por favor verifica tu número de teléfono para continuar.',
    ...
    'biometric-not-enrolled':
        'No hay datos biométricos registrados. Configúralos en los ajustes del dispositivo.',
    'invalid-credentials':
        'Credenciales inválidas. Verifica tu información e intenta de nuevo.',
    'social-login-cancelled': 'Inicio de sesión cancelado.',
    'social-login-failed':
        'Error al iniciar sesión con redes sociales. Intenta con otro método.',

    // Mensajes de validación
    'invalid-phone-format':
        'El número debe ser peruano y empezar con 9 (9 dígitos en total).',
    'invalid-name-format':
