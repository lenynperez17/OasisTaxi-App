...
class PreferenceService {
  ...
  static bool getSmsNotifications() =>
      _prefs.getBool(smsNotifications) ?? false;
  ...
  // Métodos SET
  static Future<bool> setNotificationsEnabled(bool value) =>
      _prefs.setBool(notificationsEnabled, value);
  static Future<bool> setLocationServices(bool value) =>
      _prefs.setBool(locationServices, value);
  ...
  static Future<bool> setShareLocation(bool value) =>
      _prefs.setBool(shareLocation, value);
  static Future<bool> setShareTrips(bool value) =>
      _prefs.setBool(shareTrips, value);
  static Future<bool> setAnalytics(bool value) =>
      _prefs.setBool(analytics, value);
  static Future<bool> setCrashReports(bool value) =>
      _prefs.setBool(crashReports, value);

  static Future<bool> setPushNotifications(bool value) =>
      _prefs.setBool(pushNotifications, value);
  static Future<bool> setEmailNotifications(bool value) =>
      _prefs.setBool(emailNotifications, value);
  static Future<bool> setSmsNotifications(bool value) =>
      _prefs.setBool(smsNotifications, value);
  static Future<bool> setTripUpdates(bool value) =>
      _prefs.setBool(tripUpdates, value);
  static Future<bool> setPromotions(bool value) =>
      _prefs.setBool(promotions, value);
  static Future<bool> setNewsUpdates(bool value) =>
      _prefs.setBool(newsUpdates, value);

  static Future<bool> setBiometricAuth(bool value) =>
      _prefs.setBool(biometricAuth, value);
  static Future<bool> setTwoFactorAuth(bool value) =>
      _prefs.setBool(twoFactorAuth, value);
  static Future<bool> setAutoLockTime(int value) =>
      _prefs.setInt(autoLockTime, value);

  static Future<bool> setAutoUpdate(bool value) =>
      _prefs.setBool(autoUpdate, value);
  static Future<bool> setOfflineMaps(bool value) =>
      _prefs.setBool(offlineMaps, value);
  static Future<bool> setMapStyle(String value) =>
      _prefs.setString(mapStyle, value);
  static Future<bool> setSoundEffects(bool value) =>
      _prefs.setBool(soundEffects, value);
  static Future<bool> setHapticFeedback(bool value) =>
      _prefs.setBool(hapticFeedback, value);

  static Future<bool> setSyncOnWiFiOnly(bool value) =>
      _prefs.setBool(syncOnWiFiOnly, value);
  static Future<bool> setCompressImages(bool value) =>
      _prefs.setBool(compressImages, value);
